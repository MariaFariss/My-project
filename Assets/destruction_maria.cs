...
public class destruction_maria : MonoBehaviour
{
    ...
    private void DestroyMesh()
    {
        ...
        //add emmission particules spawnParticles()
        ...
        for (var i = 0; i < parts.Count; i++)
        {
            ...
            //parts[i].GameObject.GetComponent<Rigidbody>().AddExplosionForce(ExplodeForce, transform.position, 10);
            //emission cube particules
            spawnParticles();
            Destroy(parts[i].GameObject, 5);
    ...
    void spawnParticles()
    {
        //particleSystemObject = Instantiate(particleSystemObject, transform.position, Quaternion.identity);
    ...
    public class PartMesh
    {
        ...
        public void MakeGameobject(destruction_maria original)
        {
            ...
            var meshDestroy = GameObject.AddComponent<destruction_maria>();
